...
## Що це?
`fractureiser` — це [вірус](https://ru.wikipedia.org/wiki/Компьютерный_вирус), который был найден в нескольких проектах на CurseForge и BukkitDev. Он был встроен в несколько модов, некоторые из них были в очень популярных модпаках. Известно, что вирус был нацелен только на Windows и Linux.

Если вы ещё не проверили на его наличе, вирус может быть **НЕЙМОВІРНО НЕБЕЗПЕЧНИМ** для вашего устройства. Чтобы узнать, как обезопасить себя, пожалуйста, прочтите этот документ до конца.
...
* [Хронологія Подій](docs/timeline.md)
...
Подивітьсч на [цю сторінку](docs/2023-06-08-meeting.md) о повестке дня и протоколе мероприятия.
