...
Хронологія подій снизу уверх. Події зверху - найостанніші.

---
*2023-06-09 07:48 UTC*

Створювачі ступені 3b (skyrage), судя по всьому, втратили свій домен skyrage.de (записи серверу імен та регістратору змінились, записи DNS зникли).

---
*2023-06-08 10:50 UTC*

Теперішні C&C сервера ступені 3b (skyrage) `95[.].214.27.172` та `171[.]22.30.117` більше не доступні. Слідкуємо за можливими зміненнямии DNS.

Час - коли це було замічено, а не коли це виникло.

---
*2023-06-08 05:11 UTC*

Prospector оголошує наступне:

> Оновлення від Modrinth, усі файли, завантажені за останні 10 місяців (приблизно половина наших файлів) були проскановані і жодного зараженого файлу не було знайдено.

---
*2023-06-08 01:12 UTC*

Все в основному знову заспокоїлось, вірусні сканери почали визначати jar-файли ступенів 1 та вище
як шкідливі, і на наступний ранок по США запланована зустріч для обговорення подальших кроків.

Зустріч буде полуприватною, але записи/протоколи будуть викладені після.

CurseForge сканує всі моди, але цей процесс все ще продовжуєтся.

---
*2023-06-07 18:51 UTC*

Другий C&C сервер `107[.]189.3.101` був зупиненим хостинг-провайдером.

---
*2023-06-07 16:00 UTC*

Через затримки у HackMD, цей документ був перенесений у репозиторій GitHub
...
Домен Cloudflare Pages переключився на новий IP-адрес, `107.189.3.101`.
...
C&C сервер був відключений провайдером. Можливо з'явиться новий, якщо сторінка Cloudflare залишиться на місці, слідкуємо за цим.
...
Команда, створювавша цей документ, дізнається о шкідливих файлах, включених у постороннє оновлення Better Minecraft.
