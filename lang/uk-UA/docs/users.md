...
Якщо ви **граєте тільки** у ванільну гру через перевірений лаунчер, наприклад як офіційний лаунчер від Mojang або Prism, і ніколи не трогали моди: ви в 100% безпеки. Тримайтесь поки що подалі від модів.

Якщо ви граєте у Minecraft з модами, вам необхідно перевірити, не заражені чи ви
шкідливою програмою fractureiser, чтобы убедиться, что ваша машина и личные данные не подверглись риску.
Это можно сделать с помощью приведенных ниже инструкций.

### Це все ще продовжується??
**Ні. Ну, типу того.**
На даний момент, з нашими теперішніми знаннями, ми враховуємо, що вірус `fractureiser` був повністю очищено
з нинішніх публічних модів/модпаків.

Наша теперішня рекомендация заключается в том, что игроки, запустившие проверяльщик второй ступени (stage 2 checker) с этой страницы, могут спокойно
...
### Структура страницы
* [Що на самому ділі сталося?](#що-на-самому-ділі-сталося)
* [Заражений чи я?](#заражений-чи-я)
* [Я заражен, что теперь?](#я-заражен-что-теперь)
* [Я не заражен, что теперь?](#я-не-заражен-что-теперь)
* [Часто задаваемые вопросы](#часто-задаваемые-вопросы)
* [Технічне FAQ](#технічне-faq)
...
(Более подробную информацию см. в [технічних деталях](tech.md))

Судя по поведению, ми **дуже впевнені**, что это - **целенаправленная атака на
...
### Чи є в моїх мод-файлах Ступінь 0?
Существует множество сканеров, которые берут файл мода и определяют, заражен ли он Ступенью 0
вредоноса.

* [Сканер](https://github.com/overwolf/jar-infection-scanner/releases) від Overwolf
  * Рекомендуємий вариант для проверки всей игры - просто направьте его на папку с установленным CurseForge
...
* [Вебсайтовий онлайн сканер](https://douira.github.io/fractureiser-web-detector/) від douira
* [nekodetector](https://github.com/MCRcortex/nekodetector/releases) від cortex
  * Нажміть на "Assets", щоб показати запускаємий файл - вимагає встановленої Java.
...
### Чи може fractureiser вирватись з ВМ (віртуальних машин)?
